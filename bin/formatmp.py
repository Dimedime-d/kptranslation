# Goal - generate usable binaries to insert into multiplayer payloads
# 2. a 0x1000 byte size binary file containing lowercase ascii and the bubble numbers, then compress it.
