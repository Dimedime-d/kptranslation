...
"""
    ...
    def __init__(self, img_file, palette_key, armips_id, offset, palette_off=""):
        self.img_file = os.path.join(RESOURCE_FOLDER, img_file)
    ...
    def quantize_image_to_palette_and_save(img_file, palette):
        ...
        converted_file = os.path.join(TEMP_FOLDER, f"{os.path.basename(img_file)[:-4]}-converted.png")
...
"""
    ...
    def __init__(self, text_imgs, pic_img, palette_key, ids, offs, palette_off):
        ...
        self.text_img_files = [os.path.join(RESOURCE_FOLDER, img) for img in text_imgs]
        self.pic_img_file = os.path.join(RESOURCE_FOLDER, pic_img)
    ...
    def format(self):
        ...
        uncomp_tiles, uncomp_maps = self.merge_binaries(shared_tiles_uncomp, text_maps, pic_tiles, pic_map, sideways=self.minigame_id.startswith("fall"))
        
        if len(uncomp_tiles) > 0x4000:
            print("WARNING: Tileset size exceeds 0x4000 bytes. Screen will glitch out in Single Pak Versus mode.")
...
minigame_splash_groups = [
    ...
    MinigameSplashGroup(["crossfire-text.png", "crossfire-challenge-text.png", "crossfire-multi-text.png"], "crossfire-pic.png", "crossfire",
        ["crossfire", "crossfire_challenge", "crossfire_multi"], ["0x0802E6F4", "0x0802E804", "0x0802E914"], "0x247CE4"),
    MinigameSplashGroup(["star-text.png", "star-challenge-text.png", "star-multi-text.png"], "star-pic.png", "star",
        ["star", "star_challenge", "star_multi"], ["0x0802E704", "0x0802E814", "0x0802E924"], "0x24930C"),
    MinigameSplashGroup(["bounce-text.png", "bounce-challenge-text.png", "bounce-multi-text.png"], "bounce-pic.png", "bounce",
        ["bounce", "bounce_challenge", "bounce_multi"], ["0x0802E714", "0x0802E824", "0x0802E934"], "0x25D3F8"),
    MinigameSplashGroup(["hockey-challenge-text.png", "hockey-multi-text.png"], "hockey-pic.png", "hockey",
        ["hockey_challenge", "hockey_multi"], ["0x0802E834", "0x0802E944"], "0x24AE38"),
    MinigameSplashGroup(["dots-text.png", "dots-challenge-text.png", "dots-multi-text.png"], "dots-pic.png", "dots",
        ["dots", "dots_challenge", "dots_multi"], ["0x0802E734", "0x0802E844", "0x0802E954"], "0x24C33C"),
    MinigameSplashGroup(["grass-text.png", "grass-challenge-text.png", "grass-multi-text.png"], "grass-pic.png", "grass",
        ["grass", "grass_challenge", "grass_multi"], ["0x0802E744", "0x0802E854", "0x0802E964"], "0x24E1D8"),
    MinigameSplashGroup(["ice-text.png", "ice-challenge-text.png", "ice-multi-text.png"], "ice-pic.png", "ice",
        ["ice", "ice_challenge", "ice_multi"], ["0x0802E754", "0x0802E864", "0x0802E974"], "0x24FA5C"),
    MinigameSplashGroup(["sky-text.png", "sky-challenge-text.png", "sky-multi-text.png"], "sky-pic.png", "sky",
        ["sky", "sky_challenge", "sky_multi"], ["0x0802E764", "0x0802E874", "0x0802E984"], "0x250EDC"),
    MinigameSplashGroup(["flip-challenge-text.png", "flip-multi-text.png"], "flip-pic.png", "flip",
        ["flip_challenge", "flip_multi"], ["0x0802E884", "0x0802E994"], "0x2526A4"),
    MinigameSplashGroup(["love-challenge-text.png", "love-multi-text.png"], "love-pic.png", "love",
        ["love_challenge", "love_multi"], ["0x0802E894", "0x0802E9A4"], "0x254024"),
    MinigameSplashGroup(["fall-text.png", "fall-challenge-text.png", "fall-multi-text.png"], "fall-pic.png", "fall",
        ["fall", "fall_challenge", "fall_multi"], ["0x0802E794", "0x0802E8A4", "0x0802E9B4"], "0x255E74"),
    MinigameSplashGroup(["magnet-text.png", "magnet-challenge-text.png", "magnet-multi-text.png"], "magnet-pic.png", "magnet",
        ["magnet", "magnet_challenge", "magnet_multi"], ["0x0802E7A4", "0x0802E8B4", "0x0802E9C4"], "0x25795C"),
    MinigameSplashGroup(["race-text.png", "race-challenge-text.png", "race-multi-text.png"], "race-pic.png", "race",
        ["race", "race_challenge", "race_multi"], ["0x0802E7B4", "0x0802E8C4", "0x0802E9D4"], "0x2593E8"),
    MinigameSplashGroup(["shoot-text.png", "shoot-challenge-text.png", "shoot-multi-text.png"], "shoot-pic.png", "shoot",
        ["shoot", "shoot_challenge", "shoot_multi"], ["0x0802E7C4", "0x0802E8D4", "0x0802E9E4"], "0x25A628"),
    MinigameSplashGroup(["twin-text.png", "twin-challenge-text.png", "twin-multi-text.png"], "twin-pic.png", "twin",
        ["twin", "twin_challenge", "twin_multi"], ["0x0802E7D4", "0x0802E8E4", "0x0802E9F4"], "0x25BDE8"),
]
...
def main():
    ...
    format_splash_inserter(minigame_splash_groups, MinigameSplashGroup.asm_outfile, MinigameSplashGroup.asm_header) # Minigame instructions before you begin
